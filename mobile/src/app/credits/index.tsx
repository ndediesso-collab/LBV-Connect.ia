...
> = {
  light_pack: { name: "Léger", credits: 20_000, durationDays: 35 },
  intermediate_pack: {
    name: "Intermédiaire",
    credits: 36_000,
    durationDays: 35,
  },
  pro_pack: { name: "Pro", credits: 48_000, durationDays: 35 },
  business_pack: { name: "Business", credits: 160_000, durationDays: 35 },
};
